...
" Markdown mdl also requires installing it with `gem install mdl`
" See https://github.com/mivok/markdownlint
let g:syntastic_markdown_mdl_checker = 1
...
" Better symbols, source: https://coderwall.com/p/zneomg/better-vim-syntastic-symbols
